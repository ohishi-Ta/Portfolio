      ...
      <div className={style.page__inner}>
        ...
        <p>
          ...
          <span className={style.page__header_text}>
            ...
            <br />
            Udemyや資格取得、技術本などを通じて、TerraformやAWSリソースの使用方法、ReactやNext.jsを使用したWeb開発を学びました。このポートフォリオはNext.js+microCMSで作成し、GithubActionsでCI/CD環境を実装しました。
          </span>
          ...
          <span className={style.page__header_text}>
            ...
            <br />
            インフラ分野の中でも現在広く普及しているクラウド技術に興味を持っており、Terraformなどを活用したIaCに強いクラウドエンジニアを目指しています。<br />これからも積極的に資格取得や自学、他社勉強会などスキル向上に向けた活動を継続し、一日でも早く貢献できるよう努力を続けてまいります。
